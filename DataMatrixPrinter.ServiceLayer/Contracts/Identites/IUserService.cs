...
namespace DataMatrixPrinter.ServiceLayer.Contracts.Identites
{
    public interface IUserService : IDisposable
    {
        ...
        Task<UserVM> RegisterUser(ApplicationUser Model, List<CustomRole> roles, HttpPostedFile File);
        ...
        ApplicationUser FindUser(string userNae, bool isremember);

        Task<List<UserVM>> GetAllUsersInfoAsync(ApplicationUser predicate);

        Task<UserVM> UpdateUser(UserVM input, HttpPostedFile imageFile = null);

        //// custom edit
        //Task<AddUserResponse> RegisterAsync(AddUserRequest entityViewModel);
        //Task<List<SelectUserViewModel>> GetAllUserAsync();
        //Task<List<SelectUserDropDown>> GetAllUserForDropDownAsync();
        //Task<AddUserInRoleRespone> AddUserInRoleAsync(AddUserInRoleRequest request);
        //Task<List<SelectUserForListItemViewModel>> GetAvailableInstallerForListItemAsync();
        //Task<bool> SendSmsForCustomer(SendSmsCustomerViewModel entityViewModel);
        //Task<SelectCurrentUserViewModel> GetCurrentUserViewModelAsync();
        //Task<UpdateUserRespone> UpdatePersonalUserInfoAsync(UpdateUserRequest request);
        //Task<UpdateUserRespone> UpdatePasswordUserAsync(UpdateUserRequest request);
    }
}